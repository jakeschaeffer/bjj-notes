...
export function PositionPicker({
  ...
  const PositionRow = ({
    ...
    return (
      <div className="flex items-center justify-between gap-2 rounded-lg border border-[var(--gg-border)] bg-[var(--gg-surface-2)] px-3 py-2 text-left text-sm text-[var(--gg-text)]">
        <button
          type="button"
        ...
        >
          ...
          {showPath ? (
            <span className="block text-xs text-[var(--gg-text-muted)]">
        ...
        {hasChildren && onDrill ? (
          <button
            ...
            className="rounded-full px-2 text-xs text-[var(--gg-text-muted)] transition hover:text-[var(--gg-text)]"
        ...
        <div className="space-y-4">
          ...
          {currentParentId && !isSearching ? (
            <button
              ...
              className="w-full rounded-lg border border-[rgba(46,242,196,0.4)] bg-[rgba(46,242,196,0.12)] px-3 py-2 text-left text-sm font-semibold text-[var(--gg-text)]"
            >
